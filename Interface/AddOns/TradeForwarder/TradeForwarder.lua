...
L["BIG_UPDATE"] = "Trade Forwarder: This addon was broken in 5.4 by Blizzard's change to show the realm name after the character name. Since the addon depends on other players to also have the most recent version, please encourage others to update! Get it from http://wow.curse.com/downloads/wow-addons/details/tradeforwarder.aspx|r"
...
TFW_CHANNEL_NAME="TCForwarder5IIll";
